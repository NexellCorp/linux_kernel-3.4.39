#ifndef __ALCDUMMY_H__
#define __ALCDUMMY_H__


#define ALCDUMMY_RESET						0X00			//RESET CODEC TO DEFAULT
#define ALCDUMMY_SPK_OUT_VOL					0X02			//SPEAKER OUT VOLUME
#define ALCDUMMY_SPK_HP_MIXER_CTRL			0X03			//SPEAKER/HP OUTPUT MIXER CONTROL
#define ALCDUMMY_HP_OUT_VOL					0X04			//HEADPHONE OUTPUT VOLUME
#define ALCDUMMY_AUXOUT_VOL					0X06			//AUXOUT OUTPUT VOLUME
#define ALCDUMMY_LINE_IN_1_VOL				0X08			//LINE IN 1 VOLUME
#define ALCDUMMY_LINE_IN_2_VOL				0X0A			//LINE IN 2 VOLUME
#define ALCDUMMY_DAC_CTRL						0X0C			//DAC CONTROL
#define ALCDUMMY_DAC_DIG_VOL					0X0E			//DAC DIGITAL VOLUME CONTROL
#define ALCDUMMY_MIC_CTRL_1					0X10			//MICPHONE INPUT CONTROL
#define ALCDUMMY_ADC_CTRL						0X12			//ADC CONTROL
#define ALCDUMMY_REC_MIXER_CTRL				0X14			//RECORD MIXER CONTROL
#define ALCDUMMY_ADC_DIG_VOL					0X16			//ADC DIGITAL VOL CONTROL
#define ALCDUMMY_HPMIXER_CTRL					0X18			//HP MIXER CONTROL
#define ALCDUMMY_AUXMIXER_CTRL				0X1A			//AUX MIXER CONTROL
#define ALCDUMMY_SPKMIXER_CTRL				0X1C			//SPEAKER MIXER CONTROL
#define ALCDUMMY_SPK_AMP_CTRL					0X1E			//SPEAKER AMPLIFIER CONTROL
#define ALCDUMMY_MIC_CTRL_2					0X22			//MICROPHONE CONTROL 2
#define	ALCDUMMY_SDP_CTRL						0X34			//STEREO I2S SERIAL DATA PORT CONTROL
#define ALCDUMMY_STEREO_AD_DA_CLK_CTRL		0X38			//STEREO AD/DA CLOCK CONTROL
#define	ALCDUMMY_PWR_MANAG_ADD1				0X3A			//POWER MANAGMENT ADDITION 1
#define	ALCDUMMY_PWR_MANAG_ADD2				0X3B			//POWER MANAGMENT ADDITION 2
#define ALCDUMMY_PWR_MANAG_ADD3				0X3C			//POWER MANAGMENT ADDITION 3
#define ALCDUMMY_PWR_MANAG_ADD4				0X3E			//POWER MANAGMENT ADDITION 4
#define ALCDUMMY_GEN_PUR_CTRL_1				0X40			//GENERAL PURPOSE CONTROL REGISTER
#define	ALCDUMMY_GBL_CLK_CTRL					0X42			//GLOBAL CLOCK CONTROL
#define ALCDUMMY_PLL_CTRL						0X44			//PLL CONTROL
#define ALCDUMMY_DIG_BEEP_IRQ_CTRL			0X48			//DIGITAL BEEP GEN AND IRQ CONTROL
#define ALCDUMMY_INT_ST_STICKY_CTRL			0X4A			//INTERNAL STATUS AND STICKY CONTROL
#define ALCDUMMY_GPIO_CTRL_1					0X4C			//GPIO CONTROL 1
#define ALCDUMMY_GPIO_CTRL_2					0X4D			//GPIO CONTROL 2
#define ALCDUMMY_GEN_PUR_CTRL_2				0X52			//GENERAL PURPOSE CONTROL REGISTER
#define ALCDUMMY_DEPOP_CTRL_1					0X54			//DEPOP MODE CONTROL 1
#define ALCDUMMY_DEPOP_CTRL_2					0X56			//DEPOP MODE CONTROL 2
#define ALCDUMMY_JACK_DET_CTRL				0X5A			//JACK DETECT CONTROL REGISTER
#define ALCDUMMY_ZC_SM_CTRL_1					0X5C			//ZERO CROSS AND SOFT VOLUME CONTROL 1
#define ALCDUMMY_ZC_SM_CTRL_2					0X5D			//ZERO CROSS AND SOFT VOLUME CONTROL 2
#define ALCDUMMY_ALC_CTRL_1					0X64			//ALC CONTROL 1
#define ALCDUMMY_ALC_CTRL_2					0X65			//ALC CONTROL 2
#define ALCDUMMY_ALC_CTRL_3					0X66			//ALC CONTROL 3
#define ALCDUMMY_PSEUDO_SPATL_CTRL			0X68			//PSEUDO STEREO AND SPATIAL EFFECT CONTROL
#define ALCDUMMY_PRI_REG_ADD					0X6A			//INDEX ADDRESS
#define ALCDUMMY_PRI_REG_DATA					0X6C			//INDEX DATA
#define ALCDUMMY_EQ_CTRL_1					0X6E			//EQ CONTROL 1
#define ALCDUMMY_EQ_CTRL_2					0X70			//EQ CONTROL 2
#define ALCDUMMY_VERSION		  		    	0x7A			//VERSION ID
#define ALCDUMMY_VENDOR_ID1	  		    	0x7C			//VENDOR ID1
#define ALCDUMMY_VENDOR_ID2	  		    	0x7E			//VENDOR ID2
...
struct alcDUMMY_setup_data {
	unsigned short i2c_address;
	unsigned short i2c_bus;	
};


#endif //__ALCDUMMY_H__
