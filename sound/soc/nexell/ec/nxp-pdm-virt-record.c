...
{
	return snd_soc_register_codec(&pdev->dev, &soc_codec_pdm_rec, &rec_dai, 1);
}
...
static struct snd_soc_dai_link pdmrec_dai_link = {
	...
	.cpu_dai_name 	= "nxp-pdm-virt",	/* pdm_driver name */
	.platform_name  = "nxp-pcm-virt",			/* nxp_snd_pcm_driver name */
	.codec_dai_name = "dit-pdm-virt-recorder",
	.codec_name 	= "pdm-virt-dit-recorder",
	.symmetric_rates = 1,
};

static struct snd_soc_card pdmrec_card = {
	.name 			= "PDM-Virt-Recorder",		/* proc/asound/cards */
