...
NXE2000_PDATA_INIT(dc1,      0, 1000000, 2000000, 1, 1, 1000000, 1,  6);	/* 1.3V ARM */
NXE2000_PDATA_INIT(dc2,      0, 1000000, 2000000, 1, 1, 1000000, 1,  6);	/* 1.2V CORE */
...
NXE2000_PDATA_INIT(dc5,      0, 1000000, 2000000, 1, 1, 1600000, 1,  6);	/* 1.6V SYS */

NXE2000_PDATA_INIT(ldo1,     0, 1000000, 3500000, 1, 0, 3300000, 1,  0);	/* 3.3V GPS */
NXE2000_PDATA_INIT(ldo2,     0, 1000000, 3500000, 1, 1, 1800000, 1,  0);	/* 1.8V CAM1 */
...
NXE2000_PDATA_INIT(ldo5,     0, 1000000, 3500000, 1, 1, 2800000, 1,  0);	/* 2.8V VCAM */
...
NXE2000_PDATA_INIT(ldo9,     0, 1000000, 3500000, 1, 1, 1800000, 1,  0);	/* 1.8V CAM2 */
