...
#if defined(CONFIG_SECRET_3RD_BOARD)||defined(CONFIG_SECRET_3P1RD_BOARD)
NXE2000_PDATA_INIT(dc1,      0,	1000000, 2000000, 1, 1, 1100000, 1,  2);	/* 1.1V ARM */
NXE2000_PDATA_INIT(dc2,      0,	1000000, 2000000, 1, 1, 1000000, 1,  2);	/* 1.0V CORE */
...
NXE2000_PDATA_INIT(ldo9,     0,	1000000, 3500000, 0, 0,     -1, 0,  2);	/* Not Use */
...
NXE2000_PDATA_INIT(ldo3,     0,	1000000, 3500000, 1, 0, 1800000, 1,  2);	/* 1.8V SYS1 */
NXE2000_PDATA_INIT(ldo4,     0,	1000000, 3500000, 1, 0, 1800000, 1,  2);	/* 1.8V SYS */
NXE2000_PDATA_INIT(ldo5,     0,	1000000, 3500000, 0, 0,     -1, 0,  2);	/* Not Use */
NXE2000_PDATA_INIT(ldo6,     0,	1000000, 3500000, 1, 0, 3300000, 1, -1);	/* 3.3V ALIVE */
...
NXE2000_PDATA_INIT(ldo9,     0,	1000000, 3500000, 0, 0,     -1, 0,  2);	/* Not Use */
NXE2000_PDATA_INIT(ldo10,    0,	1000000, 3500000, 0, 0,     -1, 0,  2);	/* Not Use */
NXE2000_PDATA_INIT(ldortc1,  0,	1700000, 3500000, 0, 0,     -1, 0,  2);	/* Not Use */
NXE2000_PDATA_INIT(ldortc2,  0,	1000000, 3500000, 0, 0,     -1, 0,  2);	/* Not Use */
...
NXE2000_PDATA_INIT(ldo6,     0,	1000000, 3500000, 1, 0, 3300000, 1, -1);	/* 3.3V ALIVE */
NXE2000_PDATA_INIT(ldo7,     0,	1000000, 3500000, 1, 0, 3300000, 1,  2);	/* 3.3V VID */
NXE2000_PDATA_INIT(ldo8,     0,	1000000, 3500000, 0, 0, 3300000, 0,  2);	/* 3.3V AUDIO */
NXE2000_PDATA_INIT(ldo9,     0,	1000000, 3500000, 0, 0,     -1, 0,  2);	/* Not Use */
NXE2000_PDATA_INIT(ldo10,    0,	1000000, 3500000, 0, 0,     -1, 0,  2);	/* Not Use */
NXE2000_PDATA_INIT(ldortc1,  0,	1700000, 3500000, 1, 0, 1800000, 1, -1);	/* 1.8V ALIVE */
NXE2000_PDATA_INIT(ldortc2,  0,	1000000, 3500000, 1, 0, 1000000, 1, -1);	/* 1.0V ALIVE */
