...
NXE2000_PDATA_INIT(dc1,      0, 1000000, 2000000, 1, 1, 1300000, 1,  4);	/* 1.3V ARM */
NXE2000_PDATA_INIT(dc2,      0, 1000000, 2000000, 1, 1, 1200000, 1,  4);	/* 1.2V CORE */
...
NXE2000_PDATA_INIT(ldo7,     0, 1000000, 3500000, 1, 1, 3300000, 1,  0);	/* 3.3V CAM */
