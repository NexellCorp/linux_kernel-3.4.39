...
#endif
NXE2000_PDATA_INIT(ldo2,     0,	1000000, 3500000, 1, 1, 1500000, 0,  2);	/* 1.8V CAM1 */
...
NXE2000_PDATA_INIT(ldo9,     0,	1000000, 3500000, 1, 1, 1800000, 1,  2);	/* 1.8V audio */
NXE2000_PDATA_INIT(ldo10,    0,	1000000, 3500000, 1, 1, 1200000, 1,  2);	/* 1.2V audio*/
...
static struct i2c_board_info ov5645_i2c_boardinfo[] = {
    {
...
static struct nxp_v4l2_i2c_board_info sensor[] = {
    ...
    {
        .board_info = &ov5645_i2c_boardinfo[0],
        .i2c_adapter_id = 0,
    },
};
