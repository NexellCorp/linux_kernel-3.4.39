...
#if defined(CONFIG_SND_CODEC_TAS880021)
#include <linux/i2c.h>

#define	TAS880021_I2C_BUS		(0)

/* CODEC */
static struct i2c_board_info __initdata tas880021_i2c_bdi = {
	.type	= "tas880021",
	.addr	= (0x90>>1),
};

/* DAI */
struct nxp_snd_dai_plat_data tas880021_i2s_dai_data = {
	.i2s_ch	= 0,
	.sample_rate	= 48000,
...
static struct platform_device tas880021_dai = {
	.name			= "tas880021-audio",
	.id				= 0,
	.dev			= {
		.platform_data	= &tas880021_i2s_dai_data,
	}
};
#endif
...
NXE2000_PDATA_INIT(ldo4,     0, 1000000, 3500000, 0, 0, 1800000, 0,  2); /* 1.8V SYS */
...
NXE2000_PDATA_INIT(ldo7,     0, 1000000, 3500000, 0, 0, 2800000, 0,  1); /* 2.8V VID */
...
NXE2000_PDATA_INIT(ldo10,    0, 1000000, 3500000, 1, 1, 1000000, 1,  4); /* 1.2V HSIC */
...
#if defined(CONFIG_SND_CODEC_TAS880021) || defined(CONFIG_SND_CODEC_TAS880021_MODULE)
	printk("plat: add device asoc-tas880021\n");
	i2c_register_board_info(TAS880021_I2C_BUS, &tas880021_i2c_bdi, 1);
	platform_device_register(&tas880021_dai);
#endif
