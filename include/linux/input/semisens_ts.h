...
#define I2C_BUS_ID_FOR_TS			(2) /* I2C channel(bus) connected to TSC */
#endif

/* NOTE: Unused or Unassigned GPIO pin should be set to -1 */
#define UNUSED_GPIO				(-1)
#define GPIO_FOR_TS_IRQ			CFG_IO_TOUCH_SN580M_IRQ /* the number of GPIO for TSC interrupt */
#define GPIO_FOR_TS_RESETB		CFG_IO_TOUCH_SN580M_RESET
#define GPIO_FOR_TOUCH_LDO		CFG_IO_TOUCH_SN580M_POWER /* vdd_en-gpio */
...
#elif defined(CONFIG_PLAT_S5P4418_SVM_REF)
	#define IRQ_NUM_FOR_TS_INTERRUPT	PB_PIO_IRQ(GPIO_FOR_TS_IRQ)
#else
