...
#ifndef __NXB110TV_H__
#define __NXB110TV_H__

#ifdef __cplusplus 
extern "C"{ 
#endif  

#include "nxb110tv_port.h"

#define NXB110TV_CHIP_ID		0x8A
...
#define RTV_DUPLICATING_OPEN_FIC		-15 // for T-DMB and DAB
#define RTV_NOT_OPENED_FIC				-16 // for T-DMB and DAB
#define RTV_INVALID_FIC_READ_SIZE		-17 // for T-DMB and DAB
...
INT  rtvTDMB_OpenSubChannel(int demod_no, U32 dwChFreqKHz, UINT nSubChID, E_RTV_SERVICE_TYPE eServiceType, UINT nThresholdSize);
