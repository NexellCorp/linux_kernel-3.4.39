...
// Include only once.
	...
	#include "nxb110tv_rf_pll_data_isdbt.h"
#endif
	
#if defined(RTV_TDMB_ENABLE)
	#include "nxb110tv_rf_pll_data_tdmb.h"
#endif

#if defined(RTV_FM_ENABLE)
    #include "nxb110tv_rf_pll_data_fm.h"
#endif
	
#if defined(RTV_DAB_ENABLE)	
	#include "nxb110tv_rf_pll_data_dab.h"
	#include "nxb110tv_rf_pll_data_tdmb.h"
#endif

#include "nxb110tv_rf_adc_data.h"
...
//#define DEBUG_A_TEST_ZERO
 ...
 static const RTV_REG_INIT_INFO t_ISDBT_INIT[] =   
 {
	...
	{  0x60,  0x13  },
	{  0x6b,  0x85  },
 #if defined(NXB110TV_CHIP_PKG_QFN)
	{  0x6c,  0x8d  },  
	{  0x6d,  0x7d  },  

 #elif defined (NXB110TV_CHIP_PKG_WLCSP)
	{  0x6c,  0x80  },  
	{  0x6d,  0x70  },  

 #elif defined (NXB110TV_CHIP_PKG_LGA)
	{  0x6c,  0x80  },  
	{  0x6d,  0x70  },  
 #else
...
INT rtvRF_ConfigureAdcClock(int demod_no, E_RTV_TV_MODE_TYPE eTvMode, E_RTV_ADC_CLK_FREQ_TYPE eAdcClkFreqType)
{
	...
	g_eRtvAdcClkFreqType[demod_no] = eAdcClkFreqType;
...
{	
	...
	if(eAdcClkFreqType == g_eRtvAdcClkFreqType[demod_no])
		return RTV_SUCCESS;
...
INT rtvRF_SetFrequency(int demod_no, E_RTV_TV_MODE_TYPE eTvMode, UINT nChNum, U32 dwChFreqKHz)
{
#if defined(RTV_TDMB_ENABLE) || defined(RTV_DAB_ENABLE)
	int nIdx;
#endif
	...
	g_fRtvChannelChange[demod_no] = TRUE;
...
#ifdef RTV_ISDBT_ENABLE
		case RTV_TV_MODE_1SEG :
			if((g_eRtvCountryBandType[demod_no]==RTV_COUNTRY_BAND_BRAZIL) || (g_eRtvCountryBandType[demod_no]==RTV_COUNTRY_BAND_ARGENTINA))		
				nChNum -= 1;
	...
	if((nRet=rtvRF_ChangeAdcClock(demod_no, eTvMode, eAdcClkFreqType)) != RTV_SUCCESS)
		goto RF_SET_FREQ_EXIT;
