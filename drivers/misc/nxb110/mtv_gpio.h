...
#define NXB110TV_IRQ_INT                  S5PV310_GPX0(2)
...
#define NXB110TV_IRQ_INT                  IRQ_EINT6
#ifdef gpio_to_irq
	#undef gpio_to_irq
...
#define NXB110TV_IRQ_INT                  IRQ_EINT1
#ifdef gpio_to_irq
	#undef gpio_to_irq
	#define	gpio_to_irq(x)		(x)
#endif
...
#define NXB110TV_IRQ_INT                  EXYNOS5420_GPX2(6) 
#define MTV_PWR_EN_CFG_VAL              S5PV210_GPD0_PWM_TOUT_0 
...
#include <mach/soc.h>
	...
	#define MTV_PWR_EN                   CFG_DMB_ENABLE
	#define NXB110TV_IRQ_INT               CFG_DMB_IRQ
	#define NXB110TV_CS_SPI				 CFG_SPI0_CS
	
	static inline int mtv_configure_gpio(void)
	{
		printk("TNN _______ MTV_PWR_EN _______%d \n ",MTV_PWR_EN);
		//printk("TNN _______ MTV_PWR_EN_1_______%d \n ",MTV_PWR_EN_1);
		printk("TNN __ NXB110TV_IRQ_INT __%d \n ",NXB110TV_IRQ_INT);
		//printk("TNN __ NXB110TV_IRQ_INT_1____________%d \n ",NXB110TV_IRQ_INT_1);
