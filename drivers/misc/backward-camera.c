...
static void _mlc_rgb_overlay_draw(int module, struct nxp_backward_camera_platform_data *param, void *mem)
{
    if (param->draw_rgb_overlay)
        param->draw_rgb_overlay(param, mem);
}
