...
* 
* TITLE 	  : NEXELL TV RF PLL data for ISDB-T. 
*
* FILENAME    : nxtv_rf_pll_data_isdbt.h
*
* DESCRIPTION : 
...
*    DATE	  	  NAME				REMARKS
* ----------  -------------    --------------------------------------------------
* 09/30/2010  Ko, Kevin        Splited the file from nxtv_rf_pll_data_auto.h
...
********************************************************************************/
	...
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x00<<4}, {0x27, 0x03, 0x00<<0}, {0x31, 0x02, 0x00<<1}};
  
#elif (NXTV_SRC_CLK_FREQ_KHz == 16000)
	#define ISDBT_AUTO_PLLNF			0x62A926E
	#define ISDBT_AUTO_PLL_NFSTEP		0x180000
	
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x00<<4}, {0x27, 0x03, 0x01<<0}, {0x31, 0x02, 0x00<<1}};
	
#elif (NXTV_SRC_CLK_FREQ_KHz == 16384)
	#define ISDBT_AUTO_PLLNF			0x6059300 // 1seg
	#define ISDBT_AUTO_PLL_NFSTEP		0x177000
	
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x01<<4}, {0x27, 0x03, 0x00<<0}, {0x31, 0x02, 0x00<<1}};

#elif (NXTV_SRC_CLK_FREQ_KHz == 18000)	
	#define ISDBT_AUTO_PLLNF			0x57B2CD4
	#define ISDBT_AUTO_PLL_NFSTEP		0x155555
	
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x00<<4}, {0x27, 0x03, 0x02<<0}, {0x31, 0x02, 0x00<<1}};
	...
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x01<<4}, {0x27, 0x03, 0x03<<0}, {0x31, 0x02, 0x00<<1}};
  
#elif (NXTV_SRC_CLK_FREQ_KHz == 24576)		
	#define ISDBT_AUTO_PLLNF			0x403B755
	#define ISDBT_AUTO_PLL_NFSTEP		0x0FA000	
	
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x01<<4}, {0x27, 0x03, 0x03<<0}, {0x31, 0x02, 0x01<<1}};
    
#elif (NXTV_SRC_CLK_FREQ_KHz == 26000)
	#define ISDBT_AUTO_PLLNF			0x3CB6DCD
	#define ISDBT_AUTO_PLL_NFSTEP		0x0EC4EC	

	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x00<<4}, {0x27, 0x03, 0x00<<0}, {0x31, 0x02, 0x01<<1}};
	...
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x00<<4}, {0x27, 0x03, 0x01<<0}, {0x31, 0x02, 0x01<<1}};
  
#elif (NXTV_SRC_CLK_FREQ_KHz == 32768)
	#define ISDBT_AUTO_PLLNF			0x302C980
	#define ISDBT_AUTO_PLL_NFSTEP		0x0BB800
	
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x01<<4}, {0x27, 0x03, 0x00<<0}, {0x31, 0x02, 0x01<<1}};
  
#elif (NXTV_SRC_CLK_FREQ_KHz == 36000)
	#define ISDBT_AUTO_PLLNF			0x2BD966A
	#define ISDBT_AUTO_PLL_NFSTEP		0x0AAAAA
	
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x00<<4}, {0x27, 0x03, 0x02<<0}, {0x31, 0x02, 0x01<<1}};
	...
	static const NXTV_REG_MASK_INFO g_atAutoChInitData_ISDBT[] = {{0x46, 0x10, 0x00<<4}, {0x27, 0x03, 0x03<<0}, {0x31, 0x02, 0x01<<1}};
