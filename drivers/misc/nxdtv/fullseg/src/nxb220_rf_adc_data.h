...
static const U16 g_atBW_TABLE_CKSYN[MAX_NUM_NXTV_BW_MODE_TYPE][9] = 
{
/*NXTV_BW_MODE_5MHZ*/	{0x05,0x80, 0x01,0x01,0x2E,0x13,0x0E,0x01,0x0D},
/*NXTV_BW_MODE_6MHZ*/	{0x05,0x80, 0x01,0x01,0x2E,0x13,0x0E,0x01,0x0D},
/*NXTV_BW_MODE_7MHZ*/	{0x05,0x80, 0x01,0x01,0x2E,0x13,0x0E,0x01,0x0D},
/*NXTV_BW_MODE_8MHZ*/    {0x05,0x80, 0x01,0x01,0x2E,0x13,0x0E,0x01,0x0D},
/*NXTV_BW_MODE_430KHZ*/  {0x04,0x5A, 0x01,0x00,0x2E,0x13,0x0E,0x01,0x0D},
/*NXTV_BW_MODE_500KHZ*/  {0x0A,0x7B, 0x01,0x00,0x2E,0x13,0x0E,0x01,0x0D},
/*NXTV_BW_MODE_571KHZ*/  {0x14,0xAB, 0x00,0x00,0x2E,0x13,0x0E,0x01,0x0D},
/*NXTV_BW_MODE_768KHZ*/	{0x06,0x48, 0x01,0x00,0x2E,0x13,0x0E,0x01,0x0D},
/*NXTV_BW_MODE_1290KHZ*/ {0x05,0x24, 0x00,0x00,0x2E,0x13,0x0E,0x01,0x0D}
};
#elif (NXTV_SRC_CLK_FREQ_KHz == 32000)
static const U16 g_atBW_TABLE_CKSYN[MAX_NUM_NXTV_BW_MODE_TYPE][9] = 
{
/*NXTV_BW_MODE_5MHZ*/	{0x19,0x180,0x01,0x01,0x2E,0x13,0x0E,0x01,0x29},
/*NXTV_BW_MODE_6MHZ*/	{0x19,0x180,0x01,0x01,0x2E,0x13,0x0E,0x01,0x29},
/*NXTV_BW_MODE_7MHZ*/	{0x19,0x180,0x01,0x01,0x2E,0x13,0x0E,0x01,0x29},
/*NXTV_BW_MODE_8MHZ*/    {0x19,0x180,0x01,0x01,0x2E,0x13,0x0E,0x01,0x29},
/*NXTV_BW_MODE_430KHZ*/  {0x04,0x36, 0x01,0x00,0x2E,0x13,0x0E,0x01,0x29},
/*NXTV_BW_MODE_500KHZ*/  {0x0A,0x7B, 0x01,0x00,0x2E,0x13,0x0E,0x01,0x29},
/*NXTV_BW_MODE_571KHZ*/  {0x14,0xAB, 0x00,0x00,0x2E,0x13,0x0E,0x01,0x29},
/*NXTV_BW_MODE_768KHZ*/	{0x06,0x48, 0x01,0x00,0x2E,0x13,0x0E,0x01,0x29},
/*NXTV_BW_MODE_1290KHZ*/ {0x05,0x24, 0x00,0x00,0x2E,0x13,0x0E,0x01,0x29}
};
#else 
#error " NXTV_SRC_CLK_FREQ_KHz is not correct"
#endif

static const UINT g_atBW_TABLE_IIR[MAX_NUM_NXTV_BW_MODE_TYPE][14] = 
{
/*NXTV_BW_MODE_5MHZ*/	{0x02,0xBB83E,0x436A1,0xC12C0,0xC3472,0x43762,0xC1CD3,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x398FD},
/*NXTV_BW_MODE_6MHZ*/	{0x02,0x3F019,0x43426,0xC108E,0xC3063,0x43405,0xC1C85,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x3B1B1},
/*NXTV_BW_MODE_7MHZ*/	{0x02,0x416DF,0x43084,0xBFBDC,0xC1331,0x41CF0,0xC1C18,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x3B78B}, //19.2MHz
/*NXTV_BW_MODE_8MHZ*/    {0x02,0x41F50,0x41B43,0xBF8A5,0xBF1E8,0x413E4,0xC1BEC,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x3BDB2},  //19.2MHz IIR
/*NXTV_BW_MODE_430KHZ*/  {0x02,0x43721,0x43400,0xBFDE1,0x3D238,0x4329D,0xC1965,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x371E2},  
/*NXTV_BW_MODE_500KHZ*/  {0x03,0x435CF,0x43466,0xC1185,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x3B27E}, 
/*NXTV_BW_MODE_571KHZ*/  {0x02,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000},
/*NXTV_BW_MODE_768KHZ*/	{0x02,0xC17A9,0x437A7,0xC1414,0xC38C3,0x439AA,0xC1DD4,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x3B394},
/*NXTV_BW_MODE_1290KHZ*/ {0x02,0xC37D0,0x43989,0xC1523,0xBF6D4,0x43B26,0xC1DFB,0x43000,0x43000,0x43000,0x43000,0x43000,0x43000,0x3732E}
};

static const U8 g_atBW_TABLE_BBA[MAX_NUM_NXTV_BW_MODE_TYPE][7] = 
{
/*NXTV_BW_MODE_5MHZ*/	{0x2D,0x20,0x03,0x03,0x02,0x02,0x01},
/*NXTV_BW_MODE_6MHZ*/	{0x2D,0x20,0x03,0x03,0x02,0x02,0x01},
/*NXTV_BW_MODE_7MHZ*/	{0x28,0x19,0x03,0x03,0x02,0x02,0x02},
/*NXTV_BW_MODE_8MHZ*/    {0x22,0x13,0x03,0x03,0x02,0x02,0x03},
/*NXTV_BW_MODE_430KHZ*/  {0x9C,0x15,0x00,0x03,0x00,0x00,0x00},
/*NXTV_BW_MODE_500KHZ*/  {0xBF,0x20,0x03,0x03,0x02,0x02,0x00},
/*NXTV_BW_MODE_571KHZ*/  {0xBF,0x20,0x03,0x03,0x02,0x02,0x00},
/*NXTV_BW_MODE_768KHZ*/	{0xBF,0x20,0x03,0x03,0x02,0x02,0x00},
/*NXTV_BW_MODE_1290KHZ*/ {0xBF,0x20,0x03,0x03,0x02,0x02,0x00}
};

static const U8 g_atBW_TABLE_ADC[MAX_NUM_NXTV_BW_MODE_TYPE][47] = 
{
/*NXTV_BW_MODE_5MHZ*/	{0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x0A,0x20,0x1F,0x12,0x20,0x13,0x20,0x00,0x00,0x00,0x02,0x35,0x49,0x49,0x4A,0x4A,0x4A,0x4A,0x4A,0x4A,0x12,0x10,0x1F,0x1F,0x1F,0x10,0x1F,0x1F,0x1F,0x10,0x1F,0x1F,0x1F,0x30,0x30,0x30,0x18,0x00,0x00},
/*NXTV_BW_MODE_6MHZ*/	{0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x0A,0x20,0x1F,0x12,0x20,0x13,0x20,0x00,0x00,0x00,0x02,0x35,0x4F,0x4F,0x4A,0x4A,0x4A,0x4A,0x4A,0x4A,0x12,0x10,0x1F,0x1F,0x1F,0x10,0x1F,0x1F,0x1F,0x10,0x1F,0x1F,0x1F,0x30,0x30,0x30,0x18,0x00,0x00},
/*NXTV_BW_MODE_7MHZ*/	{0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x0A,0x20,0x1F,0x12,0x20,0x13,0x20,0x00,0x00,0x00,0x02,0x35,0x4F,0x4F,0x4A,0x4A,0x4A,0x4A,0x4A,0x4A,0x12,0x10,0x1F,0x1F,0x1F,0x10,0x1F,0x1F,0x1F,0x10,0x1F,0x1F,0x1F,0x30,0x30,0x30,0x18,0x00,0x00},
/*NXTV_BW_MODE_8MHZ*/    {0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x0A,0x20,0x1F,0x12,0x20,0x13,0x20,0x00,0x00,0x00,0x02,0x35,0x4F,0x4F,0x4A,0x4A,0x4A,0x4A,0x4A,0x4A,0x12,0x10,0x1F,0x1F,0x1F,0x10,0x1F,0x1F,0x1F,0x10,0x1F,0x1F,0x1F,0x30,0x30,0x30,0x18,0x00,0x00},
/*NXTV_BW_MODE_430KHZ*/  {0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x08,0x20,0x03,0x08,0x20,0x08,0x20,0x00,0x00,0x00,0x00,0x09,0x23,0x23,0x21,0x21,0x21,0x21,0x21,0x21,0x12,0x10,0x0E,0x0E,0x0E,0x10,0x0E,0x0E,0x0E,0x10,0x0E,0x0E,0x0E,0x30,0x30,0x30,0x18,0x00,0x00},
/*NXTV_BW_MODE_500KHZ*/  {0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x08,0x20,0x03,0x08,0x20,0x08,0x20,0x00,0x00,0x00,0x00,0x06,0x20,0x20,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x12,0x10,0x0D,0x0D,0x0D,0x10,0x0D,0x0D,0x0D,0x10,0x0D,0x0D,0x0D,0x30,0x30,0x30,0x18,0x00,0x00},
/*NXTV_BW_MODE_571KHZ*/  {0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x0B,0x20,0x05,0x0B,0x20,0x0B,0x20,0x00,0x00,0x00,0x00,0x0F,0x2B,0x2B,0x29,0x29,0x29,0x29,0x29,0x29,0x12,0x10,0x11,0x11,0x11,0x10,0x11,0x11,0x11,0x10,0x11,0x11,0x11,0x30,0x30,0x30,0x18,0x00,0x00},
/*NXTV_BW_MODE_768KHZ*/	{0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x08,0x20,0x03,0x08,0x20,0x08,0x20,0x00,0x00,0x00,0x00,0x06,0x20,0x20,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x12,0x10,0x0D,0x0D,0x0D,0x10,0x0D,0x0D,0x0D,0x10,0x0D,0x0D,0x0D,0x30,0x30,0x30,0x18,0x00,0x00},
/*NXTV_BW_MODE_1290KHZ*/ {0x00,0x00,0x00,0x00,0x24,0x24,0x00,0x00,0x08,0x20,0x04,0x08,0x20,0x08,0x20,0x00,0x00,0x00,0x00,0x03,0x1F,0x1F,0x1D,0x1D,0x1D,0x1D,0x1D,0x1D,0x12,0x10,0x0C,0x0C,0x0C,0x10,0x0C,0x0C,0x0C,0x10,0x0C,0x0C,0x0C,0x30,0x30,0x30,0x18,0x00,0x00}
};
/////////////////////////LNA Setting//////////////////////////////////////////
...
static const struct NXTV_ADC_CFG_INFO g_atAdcCfgTbl_ISDBT_6MHz[] = {
...
static const struct NXTV_ADC_CFG_INFO g_atAdcCfgTbl_ISDBT_7MHz[] = {
...
static const struct NXTV_ADC_CFG_INFO g_atAdcCfgTbl_ISDBT_8MHz[] = {
...
static const struct NXTV_ADC_CFG_INFO g_atAdcCfgTbl_DVBT_5MHz[] = {
...
static const struct NXTV_ADC_CFG_INFO g_atAdcCfgTbl_DVBT_6MHz[] = {
/*8*/    {0x00, 0x00, 0x00, 0x00, 0x00,0x00000000,0x00000000,0x000000,0x00},
/*9*/    {0x00, 0x00, 0x00, 0x00, 0x00,0x00000000,0x00000000,0x000000,0x00},
...
static const struct NXTV_ADC_CFG_INFO g_atAdcCfgTbl_DVBT_7MHz[] = {
/*8*/    {0x00, 0x00, 0x00, 0x00, 0x00,0x00000000,0x00000000,0x000000,0x00},
/*9*/    {0x00, 0x00, 0x00, 0x00, 0x00,0x00000000,0x00000000,0x000000,0x00},
...
static const struct NXTV_ADC_CFG_INFO g_atAdcCfgTbl_DVBT_8MHz[] = {
/*8*/    {0x00, 0x00, 0x00, 0x00, 0x00,0x00000000,0x00000000,0x000000,0x00},
/*9*/    {0x00, 0x00, 0x00, 0x00, 0x00,0x00000000,0x00000000,0x000000,0x00},
