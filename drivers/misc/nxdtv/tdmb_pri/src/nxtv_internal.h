...
extern volatile E_NXTV_ADC_CLK_FREQ_TYPE g_eRtvAdcClkFreqType;
extern E_NXTV_COUNTRY_BAND_TYPE g_eRtvCountryBandType;
...
{	
	...
	NXTV_REG_SET(0x62, g_bRtvIntrMaskRegL|MSC0_INTR_BITS|MSC1_INTR_BITS);
...
#endif
	nxtv_SetupThreshold_MSC1(g_nRtvMscThresholdSize);
