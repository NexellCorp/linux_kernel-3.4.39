...
extern volatile E_RTV_ADC_CLK_FREQ_TYPE g_eRtvAdcClkFreqType[RAONTV_MAX_NUM_DEMOD_CHIP];
extern E_RTV_COUNTRY_BAND_TYPE g_eRtvCountryBandType[RAONTV_MAX_NUM_DEMOD_CHIP];
...
extern     BOOL g_fDabEnableReconfigureIntr;
	...
	extern BOOL g_fRtvFicOpened[RAONTV_MAX_NUM_DEMOD_CHIP];
	#if defined(RTV_IF_SPI) && defined(RTV_CIF_MODE_ENABLED)
	extern U32 g_aOpenedCifSubChBits_MSC0[RAONTV_MAX_NUM_DEMOD_CHIP][2];
	#endif
...
extern volatile BOOL g_fRtvChannelChange[RAONTV_MAX_NUM_DEMOD_CHIP];
extern BOOL g_fRtvStreamEnabled[RAONTV_MAX_NUM_DEMOD_CHIP];

extern UINT g_nRtvMscThresholdSize[RAONTV_MAX_NUM_DEMOD_CHIP];	
extern U8 g_bRtvIntrMaskRegL[RAONTV_MAX_NUM_DEMOD_CHIP];
#ifdef RTV_DAB_ENABLE
