...
{
	*(U8 *)Res = (U8) (*(fig_data.data+fig_data.byte_cnt) & (FIC_BIT_MASK[cnt] >> fig_data.bit_cnt));
 ...
 S32 Get_FIG_Init(U8 *data)
{
 ...
 S32 Get_FIG_Header(FIG_DATA *fig_data)
{
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		if(fic_cmd)
		{
			if(C_N)
			{
				...
				for(cnt=0; cnt<NEXT_ENS_DESC.svr_comp_num; cnt++)
				{
					if(NEXT_ENS_DESC.svr_comp[cnt].SubChid == type0_ext1.SubChid)  ///Old SId & New SId matching 판단
					{
						NEXT_ENS_DESC.svr_comp[cnt].START_Addr  = type0_ext1.StartAdd;
						NEXT_ENS_DESC.svr_comp[cnt].SUB_CH_Size = sub_ch_size;
						NEXT_ENS_DESC.svr_comp[cnt].P_L         = p_l;
						NEXT_ENS_DESC.svr_comp[cnt].BIT_RATE    = bit_rate;
					}
				}
			}
			else
			{
				...
				{
					if(ENS_DESC.svr_comp[cnt].SubChid == type0_ext1.SubChid)  ///Old SId & New SId matching 판단
					{
						ENS_DESC.svr_comp[cnt].START_Addr  = type0_ext1.StartAdd;
						ENS_DESC.svr_comp[cnt].SUB_CH_Size = sub_ch_size;
						ENS_DESC.svr_comp[cnt].P_L         = p_l;
						ENS_DESC.svr_comp[cnt].BIT_RATE    = bit_rate;
					}
				}
			}
		}
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		for(cnt=0; cnt<type0_ext2.Num_ser_comp; cnt++)
		{
			...
			case MSC_STREAM_AUDIO:
				Get_Bits(6, &type0_ext2.svr_comp_des[cnt].ASCTy);
				Get_Bits(6, &type0_ext2.svr_comp_des[cnt].SubChid);
				Get_Bits(1, &type0_ext2.svr_comp_des[cnt].P_S);
				Get_Bits(1, &type0_ext2.svr_comp_des[cnt].CA_flag);
				break;
			case MSC_STREAM_DATA:
				Get_Bits(6, &type0_ext2.svr_comp_des[cnt].DSCTy);
				Get_Bits(6, &type0_ext2.svr_comp_des[cnt].SubChid);
				Get_Bits(1, &type0_ext2.svr_comp_des[cnt].P_S);
				Get_Bits(1, &type0_ext2.svr_comp_des[cnt].CA_flag);
				break;
			case FIDC:
				Get_Bits(6, &type0_ext2.svr_comp_des[cnt].DSCTy);
				Get_Bits(6, &type0_ext2.svr_comp_des[cnt].FIDCid);
				Get_Bits(1, &type0_ext2.svr_comp_des[cnt].P_S);
				Get_Bits(1, &type0_ext2.svr_comp_des[cnt].CA_flag);
				break;
		...
		if(fic_cmd)
		{
			...
			{
				update_flag = 1;		
				for(cnt=0; cnt<NEXT_ENS_DESC.svr_num; cnt++)
				{
					if(NEXT_ENS_DESC.svr_desc[cnt].Sid == type0_ext2.Sid)  ///Old SId & New SId matching 판단
					{
						update_flag = 0;
						break;
					}
				...
				if(update_flag)
				{
					if(P_D)
					{
						NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].P_D = 1;
						NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].ECC = type0_ext2.ECC;
					}
					else
						NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].P_D = 0;

					NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].Country_id   = type0_ext2.Country_id;
					NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].Service_ref  = type0_ext2.Service_ref;
					NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].Sid          = type0_ext2.Sid;

					NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].Local_flag   = type0_ext2.Local_flag;
					NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].CAID		   = type0_ext2.CAID;
					NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].Num_ser_comp = type0_ext2.Num_ser_comp;

					for (l = 0; l < type0_ext2.Num_ser_comp; l++)
					{
						NEXT_ENS_DESC.svr_desc[NEXT_ENS_DESC.svr_num].ser_comp_num[l] = NEXT_ENS_DESC.svr_comp_num;
						NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].TMID = type0_ext2.svr_comp_des[l].TMID;

						switch(type0_ext2.svr_comp_des[l].TMID)	// Transport Mechanism Identifier.
						{
							case MSC_STREAM_AUDIO:  // MSC stream Audio mode.
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].Sid     = type0_ext2.Sid;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].ASCTy   = type0_ext2.svr_comp_des[l].ASCTy;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].SubChid = type0_ext2.svr_comp_des[l].SubChid;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].P_S     = type0_ext2.svr_comp_des[l].P_S ;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].CA_flag = type0_ext2.svr_comp_des[l].CA_flag;
								break;
							case MSC_STREAM_DATA:   // MSC stream data mode.
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].Sid     = type0_ext2.Sid;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].DSCTy   = type0_ext2.svr_comp_des[l].DSCTy;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].SubChid = type0_ext2.svr_comp_des[l].SubChid;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].P_S     = type0_ext2.svr_comp_des[l].P_S;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].CA_flag = type0_ext2.svr_comp_des[l].CA_flag;
								break;
							case FIDC:              // FIDC mode.
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].Sid     = type0_ext2.Sid;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].DSCTy   = type0_ext2.svr_comp_des[l].DSCTy;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].FIDCid  = type0_ext2.svr_comp_des[l].FIDCid;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].P_S     = type0_ext2.svr_comp_des[l].P_S;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].CA_flag = type0_ext2.svr_comp_des[l].CA_flag;
								break;
							case MSC_PACKET_DATA:   // MSC Packet data mode.
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].Sid     = type0_ext2.Sid;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].SCid    = type0_ext2.svr_comp_des[l].SCid;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].P_S     = type0_ext2.svr_comp_des[l].P_S;
									NEXT_ENS_DESC.svr_comp[NEXT_ENS_DESC.svr_comp_num].CA_flag = type0_ext2.svr_comp_des[l].CA_flag;
								break;
						}
						NEXT_ENS_DESC.svr_comp_num++;
					}
					NEXT_ENS_DESC.svr_num++;
				}
			}
			else
			{
				...
				{
					if(ENS_DESC.svr_desc[cnt].Sid == type0_ext2.Sid)  ///Old SId & New SId matching 판단
					{
						update_flag = 0;
						break;
					}
				...
				if(update_flag)
				{
					if(P_D)
					{
						ENS_DESC.svr_desc[ENS_DESC.svr_num].P_D = 1;
						ENS_DESC.svr_desc[ENS_DESC.svr_num].ECC	= type0_ext2.ECC;
					}
					else
						ENS_DESC.svr_desc[ENS_DESC.svr_num].P_D = 0;

					ENS_DESC.svr_desc[ENS_DESC.svr_num].Country_id   = type0_ext2.Country_id;
					ENS_DESC.svr_desc[ENS_DESC.svr_num].Service_ref  = type0_ext2.Service_ref;
					ENS_DESC.svr_desc[ENS_DESC.svr_num].Sid          = type0_ext2.Sid;

					ENS_DESC.svr_desc[ENS_DESC.svr_num].Local_flag   = type0_ext2.Local_flag;
					ENS_DESC.svr_desc[ENS_DESC.svr_num].CAID		 = type0_ext2.CAID;
					ENS_DESC.svr_desc[ENS_DESC.svr_num].Num_ser_comp = type0_ext2.Num_ser_comp;

					for (l = 0; l < type0_ext2.Num_ser_comp; l++)
					{
						ENS_DESC.svr_desc[ENS_DESC.svr_num].ser_comp_num[l] = ENS_DESC.svr_comp_num;
						ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].TMID = type0_ext2.svr_comp_des[l].TMID;

						switch(type0_ext2.svr_comp_des[l].TMID)	// Transport Mechanism Identifier.
						{
							case MSC_STREAM_AUDIO:   // MSC stream Audio mode.
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].Sid     = type0_ext2.Sid;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].ASCTy   = type0_ext2.svr_comp_des[l].ASCTy;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].SubChid = type0_ext2.svr_comp_des[l].SubChid;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].P_S     = type0_ext2.svr_comp_des[l].P_S ;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].CA_flag = type0_ext2.svr_comp_des[l].CA_flag;
								break;
							case MSC_STREAM_DATA:    // MSC stream data mode.
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].Sid     = type0_ext2.Sid;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].DSCTy   = type0_ext2.svr_comp_des[l].DSCTy;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].SubChid = type0_ext2.svr_comp_des[l].SubChid;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].P_S     = type0_ext2.svr_comp_des[l].P_S;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].CA_flag = type0_ext2.svr_comp_des[l].CA_flag;
								break;
							case FIDC:               // FIDC mode.
								...
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].Sid     = type0_ext2.Sid;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].DSCTy   = type0_ext2.svr_comp_des[l].DSCTy;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].FIDCid  = type0_ext2.svr_comp_des[l].FIDCid;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].P_S     = type0_ext2.svr_comp_des[l].P_S;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].CA_flag = type0_ext2.svr_comp_des[l].CA_flag;
								break;
							case MSC_PACKET_DATA:    // MSC Packet data mode.
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].Sid     = type0_ext2.Sid;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].SCid    = type0_ext2.svr_comp_des[l].SCid;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].P_S     = type0_ext2.svr_comp_des[l].P_S;
								ENS_DESC.svr_comp[ENS_DESC.svr_comp_num].CA_flag = type0_ext2.svr_comp_des[l].CA_flag;
								break;
						}
...
S32 Get_FIG0_EXT3(U8 fic_cmd, U8 P_D, U8 C_N)
{
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		if(fic_cmd)
		{
			if(C_N)
			{
				for(k=0; k<NEXT_ENS_DESC.svr_comp_num; k++)
				{
					if((NEXT_ENS_DESC.svr_comp[k].TMID == MSC_PACKET_DATA) && 
						(NEXT_ENS_DESC.svr_comp[k].SCid == type0_ext3.SCid))
					{
						NEXT_ENS_DESC.svr_comp[k].SubChid    = type0_ext3.SubChid;
						NEXT_ENS_DESC.svr_comp[k].Packet_add = type0_ext3.Packet_add;
						NEXT_ENS_DESC.svr_comp[k].DSCTy      = type0_ext3.DSCTy;
						NEXT_ENS_DESC.svr_comp[k].DG_flag    = type0_ext3.DG_flag;
						if(type0_ext3.CA_Org_flag)
							NEXT_ENS_DESC.svr_comp[k].CA_Org = type0_ext3.CA_Org;
					}
				}
			}
			else
			{
				...
				{
					if((ENS_DESC.svr_comp[k].TMID == MSC_PACKET_DATA) && 
						(ENS_DESC.svr_comp[k].SCid == type0_ext3.SCid))
					{
						ENS_DESC.svr_comp[k].SubChid    = type0_ext3.SubChid;
						ENS_DESC.svr_comp[k].Packet_add = type0_ext3.Packet_add;
						//	2005.10.12 PNPNETWORK Louis - DSCTy, DG_flag is added
						ENS_DESC.svr_comp[k].DSCTy      = type0_ext3.DSCTy;
						ENS_DESC.svr_comp[k].DG_flag    = type0_ext3.DG_flag;
						//  2006.08.21 PNPNETWORK Lawrence - CAS add.
						if(type0_ext3.CA_Org_flag)
							ENS_DESC.svr_comp[k].CA_Org = type0_ext3.CA_Org;
					}
				}
			}
		}
		...
		if(fic_cmd)
		{
			if(C_N)
			{
				for(k=0; k<NEXT_ENS_DESC.svr_comp_num; k++)
				{
					if(type0_ext4.M_F)
					{
						if ( (NEXT_ENS_DESC.svr_comp[k].FIDCid == type0_ext4.FIDCid) )
							NEXT_ENS_DESC.svr_comp[k].CA_Org = type0_ext4.CA_Org;
					}
					else
					{
						if ( (NEXT_ENS_DESC.svr_comp[k].SubChid == type0_ext4.SubChid) )
							NEXT_ENS_DESC.svr_comp[k].CA_Org = type0_ext4.CA_Org;
					}
				}
			}
			else
			{
				for(k=0; k<ENS_DESC.svr_comp_num; k++)
				{
					if(type0_ext4.M_F)
					{
						if ( (ENS_DESC.svr_comp[k].FIDCid == type0_ext4.FIDCid) )
							ENS_DESC.svr_comp[k].CA_Org = type0_ext4.CA_Org;
					}
					else
					{
						if ( (ENS_DESC.svr_comp[k].SubChid == type0_ext4.SubChid) )
							ENS_DESC.svr_comp[k].CA_Org = type0_ext4.CA_Org;
					}
				}
			}
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		if(fic_cmd)
		{
			for(k=0; k<ENS_DESC.svr_comp_num; k++)
			{
				if(type0_ext5.L_S_flag)
				{
					if(ENS_DESC.svr_comp[k].SCid == type0_ext5.SCid)
						ENS_DESC.svr_comp[k].language = type0_ext5.Language;
				}
				else
				{
					if(type0_ext5.MSC_FIC_flag)
					{
						if(ENS_DESC.svr_comp[k].FIDCid == type0_ext5.FIDCid)
							ENS_DESC.svr_comp[k].language = type0_ext5.Language;
					}
					else
					{
						if(ENS_DESC.svr_comp[k].SubChid == type0_ext5.SubChid)
							ENS_DESC.svr_comp[k].language = type0_ext5.Language;
					}
				}
			}
		...
		if(fic_cmd)
		{
			if(C_N)
			{
				for(k=0; k<NEXT_ENS_DESC.svr_comp_num; k++)
				{
					if(type0_ext8.L_S_flag)
					{
						if(NEXT_ENS_DESC.svr_comp[k].SCid == type0_ext8.SCid)
						{
							if(NEXT_ENS_DESC.svr_comp[k].Sid == type0_ext8.Sid)
								NEXT_ENS_DESC.svr_comp[k].SCidS = type0_ext8.SCidS;
						}
					}
					else
					{
						if (type0_ext8.MSC_FIC_flag)
						{
							if(NEXT_ENS_DESC.svr_comp[k].FIDCid == type0_ext8.FIDCid)
							{
								if(NEXT_ENS_DESC.svr_comp[k].Sid == type0_ext8.Sid)
									NEXT_ENS_DESC.svr_comp[k].SCidS = type0_ext8.SCidS;
							}
						...
						{
							if(NEXT_ENS_DESC.svr_comp[k].SubChid == type0_ext8.SubChid)
							{
								if(NEXT_ENS_DESC.svr_comp[k].Sid == type0_ext8.Sid)
									NEXT_ENS_DESC.svr_comp[k].SCidS = type0_ext8.SCidS;
							}
			...
			else
			{
				for(k=0; k<ENS_DESC.svr_comp_num; k++)
				{
					if(type0_ext8.L_S_flag)
					{
						if(ENS_DESC.svr_comp[k].SCid == type0_ext8.SCid)
						{
							if(ENS_DESC.svr_comp[k].Sid == type0_ext8.Sid)
								ENS_DESC.svr_comp[k].SCidS = type0_ext8.SCidS;
						}
					}
					else
					{
						if(type0_ext8.MSC_FIC_flag)
						{
							if(ENS_DESC.svr_comp[k].FIDCid == type0_ext8.FIDCid)
							{
								if(ENS_DESC.svr_comp[k].Sid == type0_ext8.Sid)
									ENS_DESC.svr_comp[k].SCidS = type0_ext8.SCidS;
							}
						...
						{
							if(ENS_DESC.svr_comp[k].SubChid == type0_ext8.SubChid)
							{
								if(ENS_DESC.svr_comp[k].Sid == type0_ext8.Sid)
									ENS_DESC.svr_comp[k].SCidS = type0_ext8.SCidS;
							}
...
S32 Get_FIG0_EXT10(U8 fic_cmd, U8 P_D, U8 C_N)
{
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		if(fic_cmd)
		{
			...
			if (type0_ext10.UTC_flag)
			{
				ENS_DESC.date_time_info.seconds = type0_ext10.Seconds;
				ENS_DESC.date_time_info.milliseconds = type0_ext10.Milliseconds;
			}
			...
			for(i=0; i<ENS_DESC.svr_num; i++)
			{
				if(type0_ext13.Sid == ENS_DESC.svr_desc[i].Sid)
				{
					for(cnt=0; cnt<ENS_DESC.svr_desc[i].Num_ser_comp; cnt++)
					{
						...
						ENS_DESC.svr_comp[j].Num_User_App = type0_ext13.Num_User_App;
						for(k=0; k<type0_ext13.Num_User_App; k++)
						{
							ENS_DESC.svr_comp[j].User_APP_Type[k] = type0_ext13.User_APP_Type[k];
							ENS_DESC.svr_comp[j].User_APP_data_length[k] = type0_ext13.User_APP_data_length[k];
							for(p=0; p<type0_ext13.User_APP_data_length[k]; p++)
							{
								ENS_DESC.svr_comp[j].User_APP_data[p] = type0_ext13.User_APP_data[p];
							}
						}
					}
				}
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		if(fic_cmd)
		{
			if(C_N)
			{
				for(cnt=0; cnt<NEXT_ENS_DESC.svr_comp_num; cnt++)
				{
					if(type0_ext14.SubChid == NEXT_ENS_DESC.svr_comp[cnt].SubChid)
					{
						NEXT_ENS_DESC.svr_comp[cnt].FEC_scheme = type0_ext14.FEC_scheme;
					}
				}
			}
			else
			{
				for(cnt=0; cnt<ENS_DESC.svr_comp_num; cnt++)
				{
					if(type0_ext14.SubChid == ENS_DESC.svr_comp[cnt].SubChid)
					{
						ENS_DESC.svr_comp[cnt].FEC_scheme = type0_ext14.FEC_scheme;
					}
				}
			}
		}
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		if(fic_cmd)
		{
			if (ENS_DESC.svr_num != 0)
			{
				for(cnt=0; cnt<ENS_DESC.svr_num; cnt++)
				{
					if(type0_ext17.Sid == ENS_DESC.svr_desc[cnt].Sid)
					{
						ENS_DESC.svr_desc[cnt].int_code = type0_ext17.Int_code;
					}
				}
			}
		}
...
S32 Get_FIG0_EXT18(U8 fic_cmd, U8 P_D, U8 C_N)
{
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		if(fic_cmd)
		{
			for(cnt=0; cnt<ENS_DESC.svr_num; cnt++)
			{
				if(type0_ext18.Sid == ENS_DESC.svr_desc[cnt].Sid)
				{
					// Not yet implementation
				}
			}
			...
			for(cnt=0; cnt<ENS_DESC.svr_num; cnt++)
			{
				if(sid == ENS_DESC.svr_desc[cnt].Sid)
				{
					if(!ENS_DESC.svr_desc[cnt].label_flag)
					{
						...
						ENS_DESC.svr_desc[cnt].charset = Char_Set;
						memcpy(ENS_DESC.svr_desc[cnt].Label, label, 17);
...
S32 Get_FIG1_EXT4(U8 fic_cmd, U8 Char_Set)
{
	...
	while(fig_data.byte_cnt < fig_data.length)
	{
		...
		if(fic_cmd)
		{
			...
			for(k=0; k<ENS_DESC.svr_comp_num; k++)
			{
				if((ENS_DESC.svr_comp[k].Sid == sid) && (ENS_DESC.svr_comp[k].SCidS == SCidS)) 
				{
					for(i=15; i>=0; i--)
					{
						if(label[i] != 0x20)
					...
					ENS_DESC.svr_comp[k].charset = Char_Set;
					memcpy(ENS_DESC.svr_comp[k].Label, label, 17);
					break;
				}
			}
		}
...
U8 GET_DATE_TIME(DATE_TIME_INFO *time_desc)
{
	...
	MJD_temp = ENS_DESC.date_time_info.MJD - MJD_Ref[1];  // current MJD - ref MJD
	...
	{
		if(offset_flag)
			MJDRef_month = ENS_DESC.date_time_info.MJD - MJDRef_year - 1;	
		else
			MJDRef_month = ENS_DESC.date_time_info.MJD - MJDRef_year + 1;	
	}
	...
	if(ENS_DESC.date_time_info.utc_flag)
	{
		if(time_desc->time_flag)
		{
			time_desc->hours = ENS_DESC.date_time_info.hours + offset_value;
		...
		else
		{
			if(offset_flag)
			{
				time_desc->hours = (ENS_DESC.date_time_info.hours + 12) - offset_value;
				time_desc->apm_flag = 1;
			}
			else
			{
				time_desc->hours = (ENS_DESC.date_time_info.hours + offset_value) - 24;
				time_desc->apm_flag = 0;
			}
		}
...
/* FIC Information Variable  */
/*****************************/
ENSEMBLE_DESC  ENS_DESC, NEXT_ENS_DESC;
U32 FIC_CONUT = 0;
...
UINT rtvFICDEC_GetEnsembleInfo(RTV_FIC_ENSEMBLE_INFO *ptEnsemble)
{
	UINT i, j;
	UINT Comp_Index = 0;
	UINT nSubChIdx = 0;

	strncpy((char *)ptEnsemble->szEnsembleLabel, ENS_DESC.Label, RTV_MAX_ENSEMBLE_LABEL_SIZE);

	//ptEnsemble->bTotalSubCh = ENS_DESC.svr_comp_num;
	ptEnsemble->wEnsembleID = ENS_DESC.id;

	for(i=0; i<ENS_DESC.svr_num; i++)
	{
		for(j=0; j<ENS_DESC.svr_desc[i].Num_ser_comp; j++)
		{
			Comp_Index = ENS_DESC.svr_desc[i].ser_comp_num[j];			
			switch( ENS_DESC.svr_comp[Comp_Index].TMID )
			{
				case MSC_STREAM_AUDIO:
					ptEnsemble->tSubChInfo[nSubChIdx].bSubChID = ENS_DESC.svr_comp[Comp_Index].SubChid;
					ptEnsemble->tSubChInfo[nSubChIdx].wBitRate = ENS_DESC.svr_comp[Comp_Index].BIT_RATE;
					ptEnsemble->tSubChInfo[nSubChIdx].wStartAddr = ENS_DESC.svr_comp[Comp_Index].START_Addr;
					ptEnsemble->tSubChInfo[nSubChIdx].bTMId = ENS_DESC.svr_comp[Comp_Index].TMID;
					ptEnsemble->tSubChInfo[nSubChIdx].bSvcType = ENS_DESC.svr_comp[Comp_Index].ASCTy;
					ptEnsemble->tSubChInfo[nSubChIdx].nSvcID = ENS_DESC.svr_desc[i].Sid;
					memcpy(ptEnsemble->tSubChInfo[nSubChIdx].szSvcLabel, ENS_DESC.svr_desc[i].Label, RTV_MAX_SERVICE_LABEL_SIZE);
					break;
				...
				case MSC_STREAM_DATA:
					...
					ptEnsemble->tSubChInfo[nSubChIdx].wStartAddr = ENS_DESC.svr_comp[Comp_Index].START_Addr;
					ptEnsemble->tSubChInfo[nSubChIdx].bTMId = ENS_DESC.svr_comp[Comp_Index].TMID;
					ptEnsemble->tSubChInfo[nSubChIdx].bSvcType = ENS_DESC.svr_comp[Comp_Index].DSCTy;
					ptEnsemble->tSubChInfo[nSubChIdx].nSvcID = ENS_DESC.svr_desc[i].Sid;
					memcpy(ptEnsemble->tSubChInfo[nSubChIdx].szSvcLabel, ENS_DESC.svr_desc[i].Label, RTV_MAX_SERVICE_LABEL_SIZE);
					break;
...
void rtvFICDEC_Init(void )
{
	...
	FIC_CONUT = 0;
	memset(&ENS_DESC, 0, sizeof(ENSEMBLE_DESC));
}


E_RTV_FIC_DEC_RET_TYPE rtvFICDEC_Decode(unsigned char *fic_buf, unsigned int fic_size)
{
	UINT ret;
