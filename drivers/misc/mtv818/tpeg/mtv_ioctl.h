...
#define RAONTV_DEV_NAME		"mtv818_tpeg"
...
#define IOCTL_TEST_MTV_POWER_ON	_IOWR(RAONTV_IOC_MAGIC, 0, IOCTL_TEST_MTV_POWER_ON_INFO)
#define IOCTL_TEST_MTV_POWER_OFF	_IOWR(RAONTV_IOC_MAGIC, 1, IOCTL_TEST_MTV_POWER_ON_INFO)
...
#define IOCTL_ISDBT_POWER_ON		_IOWR(RAONTV_IOC_MAGIC,10, IOCTL_ISDBT_POWER_ON_INFO)
#define IOCTL_ISDBT_POWER_OFF		_IO(RAONTV_IOC_MAGIC, 11)
#define IOCTL_ISDBT_SCAN_FREQ		_IOWR(RAONTV_IOC_MAGIC,12, IOCTL_ISDBT_SCAN_INFO)
#define IOCTL_ISDBT_SET_FREQ		_IOWR(RAONTV_IOC_MAGIC,13, IOCTL_ISDBT_SET_FREQ_INFO)
...
#define IOCTL_ISDBT_STOP_TS			_IOR(RAONTV_IOC_MAGIC, 18, int)
...
#define IOCTL_TDMB_POWER_ON			_IOR(RAONTV_IOC_MAGIC, 30, IOCTL_POWER_ON_INFO)
#define IOCTL_TDMB_POWER_OFF		_IOR(RAONTV_IOC_MAGIC, 31, IOCTL_POWER_OFF_INFO)
#define IOCTL_TDMB_SCAN_FREQ		_IOWR(RAONTV_IOC_MAGIC,32, IOCTL_TDMB_SCAN_INFO)
#define IOCTL_TDMB_OPEN_FIC			_IOR(RAONTV_IOC_MAGIC, 33, IOCTL_OPEN_FIC_INFO)
#define IOCTL_TDMB_CLOSE_FIC		_IOR(RAONTV_IOC_MAGIC, 34, IOCTL_CLOSE_FIC_INFO)
...
#define IOCTL_TDMB_CLOSE_SUBCHANNEL		_IOW(RAONTV_IOC_MAGIC,37, IOCTL_CLOSE_SUBCHANNEL_INFO)
#define IOCTL_TDMB_CLOSE_ALL_SUBCHANNELS	_IOR(RAONTV_IOC_MAGIC,38, IOCTL_CLOSE_ALL_SUBCHANNELS_INFO)
#define IOCTL_TDMB_GET_LOCK_STATUS		_IOR(RAONTV_IOC_MAGIC,39, IOCTL_TDMB_GET_LOCK_STATUS_INFO)
