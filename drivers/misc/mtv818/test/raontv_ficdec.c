...
/*****************************/
static FIG_DATA fig_data[RAONTV_MAX_NUM_DEMOD_CHIP];
...
/* FIC Information Variable  */
/*****************************/
ENSEMBLE_DESC  ENS_DESC[RAONTV_MAX_NUM_DEMOD_CHIP], NEXT_ENS_DESC[RAONTV_MAX_NUM_DEMOD_CHIP];
U32 FIC_CONUT[RAONTV_MAX_NUM_DEMOD_CHIP];
...
static UINT fib_crc_err_cnt[RAONTV_MAX_NUM_DEMOD_CHIP];
...
static BOOL fic_decode_run[RAONTV_MAX_NUM_DEMOD_CHIP];
