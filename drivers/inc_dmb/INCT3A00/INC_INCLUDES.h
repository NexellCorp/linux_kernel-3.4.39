...
/* Software Update    : 2011.03.02                                               */
/*********************************************************************************/
/*********************************************************************************/
/* Operating Chip set : T3900/T3800                                              */
/* Software version   : version 1.02                                             */
/* Software Update    : 2011.03.24                                               */
/* 1. INC_INIT() : ACS improved                                                  */
/* 2. RF_Reg     : FOS enhanced                                                  */
/* 3. INC_FIC_UPDATE() : added "channel filtering"                               */
/*********************************************************************************/
/*********************************************************************************/
/* Operating Chip set : T3900/T3800                                              */
/* Software version   : version 1.03                                             */
/* Software Update    : 2011.06.30                                               */
/* 1. module driver ==> Makefile modified                                        */
/* 2. POLLING_DUMP_METHOD added : INTERRUPT_METHOD deleted                       */
/* 3. tdmb_remove & tdmb_exit added                                              */
/*********************************************************************************/
/*********************************************************************************/
/* Operating Chip set : T3900/T3800                                              */
/* Software version   : version 1.05                                             */
/* Software Update    : 2012.07.03                                               */
/* 1. ioctl -> unlock_ioctl (because kernel is updated)                          */
/*********************************************************************************/

#define INC_FW_VERSION_MAJOR	"T3A00_v1.01"
#define INC_FW_VERSION_MINOR	"1"
#define INC_FW_VERSION_DATE		"2015.01.27"
...
#define INC_INTERRUPT_PULSE_COUNT		0x03FF
...
#define INC_I2C_ID80					0x40
#define INC_I2C_ID82					0x41
#define INC_MPI_MAX_LEN					0xFFF	// 4095 

#define MPI_CS_SIZE						(188*8)
#define INC_MPI_MAX_BUFF				(1024*8)
#define INC_INTERRUPT_SIZE				(188*16)
//#define INC_INTERRUPT_SIZE				(188*8)
...
#define INC_USE_RINGBUFF
#ifdef INC_USE_RINGBUFF

#define MAX_RINGBUFF_COUNT			8		
#define MAX_BUFF_SIZE				(1024*8) //8192 // 8-Kbytes
#define MAX_GET_FIFO_SIZE			(1024*8) //8192 // 8-Kbytes
#define MAX_BUFF_FIC_DMUP_SIZE		(384*2)
//#define MAX_BUFF_DMB_DMUP_SIZE		(1024*8)	// (188*8*10) // 15040 Bytes
//#define MAX_BUFF_DMB_DMUP_SIZE		(1024*4)	// (188*8*10) // 15040 Bytes
#define MAX_BUFF_DMB_DMUP_SIZE		(188*16)	// 3008 Bytes
#define MAX_BUFF_DAB_DMUP_SIZE		(1024*2)	// 
#define MAX_BUFF_DATA_DMUP_SIZE		(1024*2)	// 
#define MAX_BUFF_TPEG_DMUP_SIZE		(1024*2)	// 
#define MAX_BUFF_EWS_DMUP_SIZE		(sizeof(ST_OUTPUT_EWS))	// 

//#define INC_INTERRUPT_MODE

typedef struct   _tagTS_DATA
{
	unsigned int	uiDataSize;
	unsigned char	aucBuff[MAX_BUFF_SIZE];
}ST_TS_DATA_INFO, *PST_TS_DATA_INFO;

typedef struct _tagTS_RINGBUFF
{
	unsigned int	uiIndexHead;
	unsigned int	uiIndexTail;
	
	unsigned int	uiGetBuffCount;
	unsigned int	uiGetBuffIndex;
	bool	bBufferFull;
	bool	bBufferEmpty;

	ST_TS_DATA_INFO	astChannelData[MAX_RINGBUFF_COUNT];
}ST_TS_RINGBUFF, *PST_TS_RINGBUFF;
