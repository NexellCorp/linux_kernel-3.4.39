/*
 * ADV7391 encoder related structure and register definitions
 *
...
#ifndef ADV7391_REGS_H
#define ADV7391_REGS_H

struct adv7391_std_info {
	u32 standard_val3;
	u32 fsc_val;
	v4l2_std_id stdid;
};
...
#define ADV7391_HD_MODE_REG3		(0x32)
#define ADV7391_HD_MODE_REG4		(0x33)
#define ADV7391_HD_MODE_REG5		(0x34)
#define ADV7391_HD_MODE_REG6		(0x35)

#define ADV7391_HD_MODE_REG7		(0x39)

#define ADV7391_SD_MODE_REG1		(0x80)
#define ADV7391_SD_MODE_REG2		(0x82)
#define ADV7391_SD_MODE_REG3		(0x83)
#define ADV7391_SD_MODE_REG4		(0x84)
#define ADV7391_SD_MODE_REG5		(0x86)
#define ADV7391_SD_MODE_REG6		(0x87)
#define ADV7391_SD_MODE_REG7		(0x88)
#define ADV7391_SD_MODE_REG8		(0x89)

#define ADV7391_SD_TIMING_REG0		(0x8A)

#define ADV7391_FSC_REG0		(0x8C)
#define ADV7391_FSC_REG1		(0x8D)
#define ADV7391_FSC_REG2		(0x8E)
#define ADV7391_FSC_REG3		(0x8F)

#define ADV7391_SD_CGMS_WSS0		(0x99)

#define ADV7391_SD_HUE_ADJUST		(0xA0)
...
#define ADV7391_HD_MODE_REG1_DEFAULT		(0x3C)	/* Changed Default
							   720p EAV/SAV code*/
#define ADV7391_HD_MODE_REG2_DEFAULT		(0x01)	/* Changed Pixel data
							   valid */
#define ADV7391_HD_MODE_REG3_DEFAULT		(0x00)	/* Color delay 0 clks */
#define ADV7391_HD_MODE_REG4_DEFAULT		(0xEC)	/* Changed */
...
#define ADV7391_SVIDEO_POWER_VALUE		(0x0C)
#define ADV7391_SD_HUE_ADJUST_DEFAULT		(0x80)
#define ADV7391_SD_BRIGHTNESS_WSS_DEFAULT	(0x00)

#define ADV7391_SD_CGMS_WSS0_DEFAULT		(0x10)

#define ADV7391_SD_MODE_REG1_DEFAULT		(0x10)
#define ADV7391_SD_MODE_REG2_DEFAULT		(0xC9)
#define ADV7391_SD_MODE_REG3_DEFAULT		(0x00)
#define ADV7391_SD_MODE_REG4_DEFAULT		(0x00)
#define ADV7391_SD_MODE_REG5_DEFAULT		(0x02)
#if 1
#define ADV7391_SD_MODE_REG6_DEFAULT		(0x20)
#else
...
#else
#define ADV7391_SD_MODE_REG7_DEFAULT		(0x02)
#endif
...
#define ADV7391_BRIGHTNESS_MAX	(63)
#define ADV7391_BRIGHTNESS_MIN	(-64)
#define ADV7391_BRIGHTNESS_DEF	(0)
#define ADV7391_HUE_MAX		(127)
#define ADV7391_HUE_MIN		(-128)
#define ADV7391_HUE_DEF		(0)
#define ADV7391_GAIN_MAX	(64)
#define ADV7391_GAIN_MIN	(-64)
#define ADV7391_GAIN_DEF	(0)
