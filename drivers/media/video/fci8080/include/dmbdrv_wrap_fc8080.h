...
u8 dmb_drv_set_ch(u32 frequency, u8 subchannel, u8 service_type);
...
int tdmb_interrupt_msc_callback(u32 userdata, u8 subchannel_id, u8 *data, int length);

#endif //__DMBDRV_WRAP_FC8080_H
