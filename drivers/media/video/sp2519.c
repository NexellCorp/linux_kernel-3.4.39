...
static struct regval_list sp2519_wb_auto_regs[] =
{
	{0xfd,0x01},
	{0x32,0x15},
	{0xfd,0x02},
...
static const struct regval_list sp2519_720p_regs[] = {
...
#define UXGA_WIDTH          1568
#define UXGA_HEIGHT         1199
#define SVGA_WIDTH          768
#define SVGA_HEIGHT         599
...
/* 1280x720 */
static const struct sp2519_win_size sp2519_win_720p = {
    .name     = "720P",
    .width    = 1280,
    .height   = 720,
    .win_regs = sp2519_720p_regs,
    .frame_rate_array = frame_rate_svga,
};
...
static int sp2519_set_white_balance_temperature(struct v4l2_subdev *sd, struct v4l2_ctrl *ctrl)
{
    ...
    switch(white_balance_temperature) {
        ...
        case WB_TUNGSTEN:
            ...
            break;
        case WB_AUTO:
            ret = sp2519_write_array(client, sp2519_wb_auto_regs);
            break;
        default:
